...
namespace TestStyledProperty.Controls
{
    public class StepIndicatorPanel : UserControl
    {
        ...
        public static readonly DirectProperty<StepIndicatorPanel, int> CurrentStepProperty =
            AvaloniaProperty.RegisterDirect<StepIndicatorPanel, int>("CurrentStep",
                o => o.CurrentStep,
                (o, v) => o.CurrentStep = v);
        ...
        public int CurrentStep
        {
            ...
            set
            {
                Console.WriteLine($"Setting CurrentStepProperty. Prev value {_currentStep}, next value {value}");
                SetAndRaise(CurrentStepProperty, ref _currentStep, value);
            }
        }
